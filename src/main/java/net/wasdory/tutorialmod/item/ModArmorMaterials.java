...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> THAUMIUM_ARMOR_MATERIAL = register( "thaumium",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attibute -> {
                attibute.put(ArmorItem.Type.HELMET, 2);
                attibute.put(ArmorItem.Type.CHESTPLATE, 6);
                attibute.put(ArmorItem.Type.LEGGINGS, 5);
                attibute.put(ArmorItem.Type.BOOTS, 2);
