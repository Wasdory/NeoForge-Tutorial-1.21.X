...
import net.wasdory.tutorialmod.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.FORTRESS_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.JUMP, 10, 1, false, false),
                                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 10, 1, false, false)))
                    .build();
